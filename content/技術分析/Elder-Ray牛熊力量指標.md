...
- **解讀**：空頭砸盤力量耗盡，順勢拉回買點
- **這就是 [[技術分析/多時間框架分析]] 的精髓**：大方向多頭 + 短期空頭力竭 = 進場
...
### 與三重濾網系統搭配
Elder-Ray 是 [[操作策略/三重濾網交易系統]] 中第二重濾網的理想工具：
- 第一重：週線 MACD 判斷大方向
...
- [[操作策略/三重濾網交易系統]] - Elder-Ray的發明者Elder設計的多時間框架系統
- [[技術分析/多時間框架分析]] - Elder-Ray適合放在中間層級使用
- [[技術分析/背離Divergence進階實戰]] - Power Divergence是背離的一種
- [[操作策略/順勢交易]] - Elder-Ray是順勢交易找進場點的最佳工具
- [[技術分析/背離Divergence進階實戰]] - 其他背離指標可交叉驗證
- [[技術分析/MACD指標實戰判讀]] - 第一重濾網常用指標
